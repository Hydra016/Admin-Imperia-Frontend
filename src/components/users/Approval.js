...
import { getAllUsers, approveUser, deleteUser } from "../../features/users/userSlice";
    ...
    return (
      <TableContainer component={Paper}>
        <Table aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell><Typography variant="subtitle1">{t("name")}</Typography></TableCell>
              <TableCell><Typography variant="subtitle1">{t("email")}</Typography></TableCell>
